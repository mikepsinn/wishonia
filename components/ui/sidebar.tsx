                    ...
                    <DropdownMenuTrigger className="w-full">
                      <div className="flex h-8 w-full flex-row items-center gap-2 rounded-md px-2 py-1.5  transition hover:bg-muted hover:text-primary">
                        <Avatar className="size-4">
                          <Image src="https://source.unsplash.com/random/16x16?avatar&sig=userAvatarSmall" alt="User Avatar" width={16} height={16} className="rounded" />
                          <AvatarFallback>
                            A
                          </AvatarFallback>
                        </Avatar>
                    ...
                    <DropdownMenuContent sideOffset={5}>
                      <div className="flex flex-row items-center gap-2 p-2">
                        <Avatar className="size-6">
                          <Image src="https://source.unsplash.com/random/24x24?avatar&sig=userAvatarLarge" alt="User Avatar" width={24} height={24} className="rounded-full" />
                          <AvatarFallback>
                            AL
                          </AvatarFallback>
                        </Avatar>
